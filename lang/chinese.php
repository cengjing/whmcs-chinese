...
$_LANG['upgradeexistingupgradeinvoice'] = "您无法升级/降级此产品，因为升级或者降级正在进行中。<br /><br />要继续, 请先支付未完成的订单。支付完您将能立刻升级或降级。<br/><br/>如果你认为此信息错误, 请提交错误工单。";
...
$_LANG['twofactorauth'] = "双重身份验证";
$_LANG['twofaenable'] = "启用 双重身份验证";
$_LANG['twofadisable'] = "关闭 双重身份验证";
$_LANG['twofaenableclickhere'] = "单击此处以启用";
$_LANG['twofadisableclickhere'] = "点击这里禁用";
$_LANG['twofaenforced'] = "为了您的安装，您必须启用 双重身份验证 才能继续。这个页面将引导你设置启用此功能。";
$_LANG['twofasetup'] = "双重身份验证设置过程";
$_LANG['twofasetupgetstarted'] = "开始";
$_LANG['twofaactivationintro'] = "双重身份验证 增加了一个额外的保护层，登录。一旦启用和配置，您每次登录不仅要输入您的用户名和密码，还要输入第二项验证，比如安全码。";
$_LANG['twofaactivationmultichoice'] = "若要继续，请从下面选择您想要的 双重身份验证。";
$_LANG['twofadisableintro'] = "要禁用双重身份验证，请在下面输入您的密码.";
$_LANG['twofaactivationerror'] = "尝试启动您帐户的 双重身份验证 功能时发生错误。请再试一次.";
$_LANG['twofamoduleerror'] = "加载模块时发生错误。请再试一次.";
$_LANG['twofaactivationcomplete'] = "双重身份验证 设置完成!";
$_LANG['twofadisableconfirmation'] = "您的帐户 双重身份验证 功能已被禁用。";
$_LANG['twofabackupcodeis'] = "您的备份代码";
$_LANG['twofanewbackupcodeis'] = "您的新的备份代码";
